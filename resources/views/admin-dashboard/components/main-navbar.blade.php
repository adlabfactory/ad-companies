                ...
                <div class="d-flex flex-wrap align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        <button class="d-flex justify-content-center align-items-center rounded-circle" type="button" data-bs-toggle="dropdown">
                            <img src="{{ asset(Auth::user()->profile->profile_picture  ?? 'assets/images/user.png') }}" alt="image" class="w-40-px h-40-px object-fit-cover rounded-circle">
                        </button>
                            ...
                            <div class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                                <div>
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        <h4 class="text-secondary-light fw-medium text-sm">
                                            {{ Auth::user()->handle }}
                                        </h4>
                                    
                                        <h3 class="text-secondary-light fw-medium text-sm">
                                            {{ Auth::user()->role }}
                                        </h3>
                                    </div>
